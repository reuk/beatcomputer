...
public:
  ...
  int get_tick_line() const {return prev;}
...
public:
  ...
  static int get_width() { return 32; }
};
...
public:
  ...
  void line_compiled(int line, CompileOutputListener::Type type,
  ...
  static int get_width() { return 50; }
};
...
public:
  CoreCoreWindow(WINDOW *parent, int height, int starty, int startx,
                 const Core &core)
      : Window(parent, height, get_width(), starty, startx), core(core) {}
  ...
  static int get_width() { return 5 + 8; }
...
public:
  CoreWindow(WINDOW *parent, const InstructionList &il, int starty, int startx)
      : Window(parent, HEIGHT, decltype(window_machine_code)::get_width() +
               ...
               starty, startx),
        il(il), memory(MEMORY_LOCATIONS),
        editor(il, decltype(window_machine_code)::Contents::get_width(),
